...
ENV['RAILS_RELATIVE_URL_ROOT'] = "{{HUBOARD_RELATIVE_URL_ROOT}}"
...
listen "{{INSTALL_DIR}}/tmp/sockets/huboard.socket", :backlog => 64
...
after_fork do |server, worker|
  ...
  defined?(ActiveRecord::Base) and
	...
	worker.user('huboard', 'huboard') if Process.euid == 0
